...
const PrivacyPolicy = props => {
  return (
    <Content>
      <Fonts.H2>What are cookies?</Fonts.H2>
      <Fonts.P>
        Cookies are small text files containing a string of characters that can be placed on your
        computer or mobile device that uniquely identifies your browser or device. We may use
        technologies like cookies, pixels and local storage to deliver, secure, and understand
        products, services, and ads.
      </Fonts.P>
      <Fonts.H2>What are cookies used for?</Fonts.H2>
      <Fonts.P>
        Cookies and other technologies allow a site or services to know if your computer or device
        has visited it before. These technologies can then be used to deliver products, services,
        and ads, help us understand how the site or service is being used, help you navigate between
        pages efficiently, help remember your preferences, and generally improve your experience in
      ...
      <Fonts.P>
        The length of time a cookie will stay on your computer or mobile device depends on whether
        it is a "persistent" or "session" cookie. Session cookies will only stay on your device
        until you stop browsing. Persistent cookies stay on your computer or mobile device until
      ...
      <Fonts.H2>How to control cookies or other collection mechanisms</Fonts.H2>
      <Fonts.P>
        Follow the instructions provided by your website or mobile browser (usually located within
        the "Help", "Tools" or "Edit" facility) to modify your cookie settings. Please note that if
        you set your browser to disable cookies or other technologies, you may not be able to access
        certain parts of our Service and other parts of our Service may not work properly. To learn
        more about the choices that advertisers provide generally for individuals to influence how
        information about their online activities over time and across third-party Web sites or
        online services is collected and used, visit{' '}
        <a href="http://www.networkadvertising.org/managing/opt_out.asp">
          the Network Advertising Initiative
        </a>
        , <a href="http://www.aboutads.info/">the Digital Advertising Alliance</a>, or{' '}
        <a href="http://youronlinechoices.eu/">the European Digital Advertising Alliance</a>.
      </Fonts.P>
      <br />
    </Content>
  );
