...
const TermsConditions = props => {
  return (
    <Content>
      <FONTS.H1>TERMS OF SERVICE</FONTS.H1>
      <Content.Seperator />
      <FONTS.H2>OVERVIEW</FONTS.H2>
      <FONTS.P>
        This website is operated by Meetsta. Throughout the site, the terms “we”, “us” and “our”
        refer to Meetsta. Meetsta offers this website, including all information, tools and services
      ...
      <FONTS.H2>SECTION 1 - ONLINE STORE TERMS</FONTS.H2>
      <FONTS.P>
        ...
        <br />
        <br />A breach or violation of any of the Terms will result in an immediate termination of
        your Services.
      </FONTS.P>

      <FONTS.H2>SECTION 2 - GENERAL CONDITIONS</FONTS.H2>
      <FONTS.P>
      ...
      <FONTS.H2>SECTION 3 - ACCURACY, COMPLETENESS AND TIMELINESS OF INFORMATION</FONTS.H2>
      <FONTS.P>
      ...
      <FONTS.H2>SECTION 4 - MODIFICATIONS TO THE SERVICE AND PRICES</FONTS.H2>
      <FONTS.P>
      ...
      <FONTS.H2>SECTION 5 - PRODUCTS OR SERVICES (if applicable)</FONTS.H2>
      <FONTS.P>
      ...
      <FONTS.H2>SECTION 6 - ACCURACY OF BILLING AND ACCOUNT INFORMATION</FONTS.H2>
      <FONTS.P>
      ...
      <FONTS.H2>SECTION 7 - OPTIONAL TOOLS</FONTS.H2>
      <FONTS.P>
      ...
      <FONTS.H2>SECTION 8 - THIRD-PARTY LINKS</FONTS.H2>
      <FONTS.P>
      ...
      <FONTS.H2>SECTION 9 - USER COMMENTS, FEEDBACK AND OTHER SUBMISSIONS</FONTS.H2>
      <FONTS.P>
      ...
      <FONTS.H2>SECTION 10 - PERSONAL INFORMATION</FONTS.H2>
      <FONTS.P>
        Your submission of personal information through the store is governed by our Privacy Policy.
        To view our Privacy Policy.
      </FONTS.P>

      <FONTS.H2>SECTION 11 - ERRORS, INACCURACIES AND OMISSIONS</FONTS.H2>
      <FONTS.P>
      ...
      <FONTS.H2>SECTION 12 - PROHIBITED USES</FONTS.H2>
      <FONTS.P>
      ...
      <FONTS.H2>SECTION 13 - DISCLAIMER OF WARRANTIES; LIMITATION OF LIABILITY</FONTS.H2>
      <FONTS.P>
        ...
        <br />
        <br />
        In no case shall Meetsta, our directors, officers, employees, affiliates, agents,
      ...
      <FONTS.H2>SECTION 14 - INDEMNIFICATION</FONTS.H2>
      <FONTS.P>
        You agree to indemnify, defend and hold harmless Meetsta and our parent, subsidiaries,
      ...
      <FONTS.H2>SECTION 15 - SEVERABILITY</FONTS.H2>
      <FONTS.P>
      ...
      <FONTS.H2>SECTION 16 - TERMINATION</FONTS.H2>
      <FONTS.P>
      ...
      <FONTS.H2>SECTION 17 - ENTIRE AGREEMENT</FONTS.H2>
      <FONTS.P>
      ...
      <FONTS.H2>SECTION 20 - CONTACT INFORMATION</FONTS.H2>
      <FONTS.P>
        Questions about the Terms of Service should be sent to us at contact.meetsta@gmail.com.
      </FONTS.P>
    </Content>
  );
};
